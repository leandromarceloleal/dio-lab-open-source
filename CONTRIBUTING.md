...
4. Crie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/digitalinnovationone/SEU_USERNAME`
    > Exemplo: `git checkout -b feat/community/digitalinnovationone/SEU_USERNAME`
